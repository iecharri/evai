...
<head>
  ...
  <meta property="og:description"  content="Plataforma educativa open source usada en universidad real durante más de 20 años. Explórala en modo demo.">
  <meta property="og:image" content="<?= DOMINIO ?>/media/og-image.png">
  
  <meta name="twitter:card"        content="summary_large_image">
  <meta name="twitter:title"       content="EVAi - Entorno Virtual de Aprendizaje Interactivo">
  <meta name="twitter:description" content="Plataforma educativa open source usada en universidad real durante más de 20 años. Explórala en modo demo.">
  <meta name="twitter:image" content="<?= DOMINIO ?>/media/og-image.png">  
