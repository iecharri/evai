...
try{
	...
	$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
                                $clConst['HTTP_CALLBACK'].': https://env0xd6ghbrsj.x.pipedream.net/' # For a fast testing of callbacks option we recommend to use http://requestb.in
...
<?php
$handle = curl_init('https://env0xd6ghbrsj.x.pipedream.net/');
