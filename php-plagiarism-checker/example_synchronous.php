...
include_once( getcwd().'/php-plagiarism-checker/autoload.php');
...
$email = 'evaielearning@gmail.com';
//$apiKey = '914C9370-84CA-4925-A7EC-C60664A4E034';
$apiKey ='CA04FD28-EC0A-47CD-905F-0A92862DAE7F';

//$email = 'inma.echarri@gmail.com';
//$apiKey = '183d1c66-0e9a-4ff0-9b0e-0002459c8205';
...
try{
	...
	//$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER']); //, // Sandbox mode - Scan without consuming any credits and get back dummy results
								//$clConst['HTTP_CALLBACK'].': https://enwn0lfin30up.x.pipedream.net/'; # For a fast testing of callbacks option we recommend to use http://requestb.in
								//$clConst['IN_PROGRESS_RESULT'].': http://iidl.evai.net/callback/results/';
   ...
   //$process  = $clCloud->createByText('<ENTER YOUR STRING HERE>'); //
	$process = $clCloud->createByFile($fichrevisar, $additionalHeaders);
